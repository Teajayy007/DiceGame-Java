...
// here the computer starts to generates its rolls
        ...
        do {  JOptionPane.showMessageDialog(null, "computer is generating rolls......");
            ...
            // this checks if the dice matches
              if (die1.getRoll() == die2.getRoll() && die2.getRoll() == die3.getRoll()) {
                        total += 3;
                 }
            else if (die1.getRoll() == die2.getRoll() || die1.getRoll() == die3.getRoll() || die2.getRoll() == die3.getRoll()) {
                        total += 2;
                 }
